...
/**
 * A set of {@link Material} that defines all {@link Material}s used in a {@link World}.
 */
public final class Materials {
    ...
    static final Material Water = new Material(TEST,"Water", FLUID, Effect.FLUID, 100)
            .addVariant("sweet", new Color(9, 125, 156, 174));

    static final Material Steam = new Material(TEST, "Steam", GASSY, Effect.GAS, 10)
            .addVariant("water", new Color(184, 227, 232));

    static final Material Poison = new Material(TEST, "Poison", FLUID, Effect.FLUID.and(pollutes(other -> other == Water)), 100)
            .addVariant("week", new Color(184, 216, 22)); //, new Color(214, 254, 29)

    static final Material Oil = new Material(TEST,"Oil", FLUID, Effect.FLUID, 40)
            .addVariant("sticky", new Color(194, 76, 36));

    static final Material Slime = new Material(TEST,"Soylent Green", SPONGY, Effect.GOO, 130)
            .addVariant("itchy", new Color(178, 226, 3))
            .addVariant("bitchy", new Color(129, 229, 94));

    static final Material Dirt = new Material(TEST,"Dirt", SOLID_GRANULAR, Effect.SOLID_GRANULAR, 600)
    ...
    static final Material LimeStone = new Material(TEST, "Lime Stone", SOLID_CRYSTALLINE, Effect.SOLID, 800)
